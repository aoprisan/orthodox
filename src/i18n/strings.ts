...
const en: Dict = {
  ...
  synaxarionSource: 'Lesser commemorations from the extended synaxarion (OCA · PasiSfinti).',
  livesTitle: 'Lives of the Saints',
  livesLoading: 'Loading…',
  livesEmpty: 'No reading available for this day.',
  livesSource: 'Source:',
  livesLangNotice: 'Romanian text — no English translation yet.',
  todayHeader: 'Today',
  julianPrefix: 'Julian:',
...
const ro: Dict = {
  ...
  synaxarionSource: 'Pomeniri din sinaxarul extins (OCA · PasiSfinti).',
  livesTitle: 'Viețile sfinților',
  livesLoading: 'Se încarcă…',
  livesEmpty: 'Nu există text disponibil pentru această zi.',
  livesSource: 'Sursă:',
  livesLangNotice: 'Text în limba română.',
  todayHeader: 'Astăzi',
  julianPrefix: 'Iulian:',
  gregorianPrefix: 'Gregorian:',
  footer:
